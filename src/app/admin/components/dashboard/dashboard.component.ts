...
interface DashboardCard { title: string; description: string; route: string; buttonText: string; }
...
export class DashboardComponent {
  ...
  readonly dashboardCards = signal<DashboardCard[]>([
    { title: 'Proyectos',       description: 'Administra tus proyectos',                          route: '/admin/projects',             buttonText: 'Ir a Proyectos' },
    { title: 'Tecnologias',     description: 'Gestiona las tecnologias disponibles',               route: '/admin/technologies',         buttonText: 'Ir a Tecnologias' },
    { title: 'Experiencia',     description: 'Carga y edita tu experiencia laboral',               route: '/admin/experience',           buttonText: 'Gestionar Experiencia' },
    { title: 'Educacion',       description: 'Carga y edita tus cursos y certificados',            route: '/admin/education',            buttonText: 'Gestionar Educacion' },
